...
The Pearson correlation coefficient, $r$, is `r round(cor(x = state_temps_income$temp, y = state_temps_income$avg_income), digits = 4)`. The coefficient of determination, $r^2$, is `r round(summary(linear_model)$r.squared, digits = 4)`.
