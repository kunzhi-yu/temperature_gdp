...
The Pearson correlation coefficient, $r$, is `r cor(x = state_temps_gdppc$temp, y = state_temps_gdppc$gdp_per_cap)`. The coefficient of determination, $r^2$, is `r summary(states_lm)$r.squared`.
